...
Future<void> main() async {
  ...
  // Change the status bar color to #1d5550
  SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
    statusBarColor: Color(0xFF1d5550), // Status bar color
...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return LockScreenManager(
      child: GetBuilder<ThemeController>(builder: (theme) {
...
class _LockScreenManagerState extends State<LockScreenManager> with WidgetsBindingObserver {
  Timer? _lockTimer;
