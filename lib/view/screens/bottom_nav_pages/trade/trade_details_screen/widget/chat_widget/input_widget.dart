...
class ChatInputWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea( // Added SafeArea to handle keyboard and system UI properly
      child: GetBuilder<RunningTradeDetailsController>(
        builder: (controller) => Container(
          width: double.infinity,
          decoration: const BoxDecoration(
              border: Border(top: BorderSide(color: MyColor.colorGrey1, width: 0.5)),
              color: Colors.white),
          child: Column(
              ...
              SizedBox(
                ...
                child: Row(
                  children: <Widget>[
                              ...
                              children: [
                                controller.isFilePathIsPdf()
                                    ...
                                    : GestureDetector(
                                        ...
                                        child: Center(
                                          child: Image.file(
                                            File(controller.fileChooserModel.choosenFile?.path ?? ''),
                                            fit: BoxFit.cover,
                                            height: 30,
                                            width: 30,
                    ...
                    // Message Input Field
                    Expanded( // Changed from Flexible to Expanded to handle space properly
                      child: Padding(
