              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(color: MyColor.customColor), // Add your border color here
                    borderRadius: BorderRadius.circular(4), // Optional: Add border radius if needed
                  ),
                  child: FilterRowWidget(
                    bgColor: MyColor.transparentColor,
                    text: controller.isBuySelected ? MyStrings.buy : MyStrings.sell,
                    press: () {
                      CustomBottomSheet.showTradeSheet(
                        [MyStrings.buy.tr, MyStrings.sell.tr], 
                        MyStrings.selectAnAdsType, 
                        context,
                      );
                    },
                  ),
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return AdvertisementListItem(
                              cryptoImagePath: '${UrlContainer.baseUrl}${controller.cryptoImagePath}/${controller.filteredAdList[index].cryptoImage}',
                              gatewayImagePath: '${UrlContainer.baseUrl}${controller.gatewayImagePath}/${controller.filteredAdList[index].fiatGatewayImage}',
                              index: index,
