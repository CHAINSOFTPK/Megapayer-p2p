        ...
        children: [
            ...
            children: [
              Row(
                ...
                Text(
                    ...
                    style: mulishSemiBold.copyWith(fontSize: Dimensions.fontDefault, color: MyColor.colorBlack,shadows: [
          ...
          Container(
            ...
            decoration:BoxDecoration(
              ...
              border: Border.all(width: 1,color: MyColor.customColor)
            ),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
               Expanded(child: SingleChildScrollView(
                 ...
                 child: Text(
                    ...
                    style: mulishRegular.copyWith(color: MyColor.textColor2, ),
                   maxLines: 1,
                  ),
               ),),
                ...
                InkWell(
                  ...
                  onTap: (){
                    ...
                    child: const Icon(Icons.copy,color: MyColor.textColor2,size: 18,)),
              ],
            ),
          ),
          const SizedBox(
                ...
                children: [
                  Expanded(
                    child: TextButton.icon(
                        ...
                        icon: const Icon(Icons.share,color: MyColor.textColor2,),
                        label:  Text(
                          " ${MyStrings.share.tr}",
