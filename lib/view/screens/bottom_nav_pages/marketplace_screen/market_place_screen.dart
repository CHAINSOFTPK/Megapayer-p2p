  ...
  Widget build(BuildContext context) {
    return WillPopWidget(
      ...
      child: Scaffold(
                          ...
                          : controller.advertisementList.isEmpty
                              ? const Expanded(
                                  child: NoDataOrInternetScreen(
                                    imageHeight: 0.3,
                                    message2:
                                        MyStrings.emptyAdvertisementLogMsg,
                                  ),
                                )
                              : Expanded(
                                          ...
                                          onTap: () {
                                            if (myAdds) {
                                              CustomSnackbar.showCustomSnackbar(
                                                errorList: [
                                                  MyStrings.ownTradeErrorMessage
                                                ],
                                                msg: [],
                                                isError: true,
                                              );
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            CircleButtonWithIcon(
                                                              ...
                                                              padding: 0,
                                                              imagePath:
                                                                  '${controller.advertisementList[index].userImage}',
                                                            ),
                                                            const SizedBox(
                                                                width: 5),
                                                            Flexible(
                                                    ...
                                                    Text(
                                                      '${MyStrings.window.tr}: ${controller.advertisementList[index].window ?? ''}'
                                                          .tr,
                                                      style: robotoRegular
                                                          .copyWith(
                                                              color: MyColor
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      flex: 2,
                                                      child: AutoSizeText(
                                                        '${MyStrings.avg.tr}: ${controller.advertisementList[index].avgSpeed ?? '--'}',
                                                        style: robotoRegular.copyWith(
                                                            color: MyColor
                                                                .colorBlack,
                                                            fontSize: Dimensions
        ...
        bottomNavigationBar: const CustomBottomNav(currentIndex: 0), // Updated currentIndex
