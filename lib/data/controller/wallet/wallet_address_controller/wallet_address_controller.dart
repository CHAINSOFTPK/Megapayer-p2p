...
class WalletAddressController extends GetxController {
  ...
  bool generateAddressLoading = false;  // Added back
  final RxBool addressGenerationCompleted = false.obs;
  final RxBool isGeneratingAddress = false.obs;
  ...
  void generateNewAddress() async {
    generateAddressLoading = true;  // Set to true
    isGeneratingAddress.value = true;
    update();
    ...
    if (response.statusCode == 200) {
      ...
      if (model.status?.toLowerCase() == MyStrings.success.toLowerCase()) {
        ...
        addressGenerationCompleted.value = true;
      } else {
    ...
    generateAddressLoading = false;  // Set to false
    isGeneratingAddress.value = false;
    update();
  }
  ...
  void resetAddressGenerationFlag() {
    addressGenerationCompleted.value = false;
  }
}