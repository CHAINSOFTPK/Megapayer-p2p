...
class MyColor {
  static const Color primaryColor = Color(0xFF1d5550);
  static const Color applightColor=Color(0xFFD2DEDE);
  static const Color colorBlack = Color(0xFF000000);
   static const Color customColor = Color(0xFF90A3A2);
  ...
  static const Color textFieldDisableBorderColor = Color(0xffCFCEDB);
   ...
   static const Color primaryColor100=Color.fromARGB(255, 37, 92, 92);
  static const Color primaryColor200=Color(0xFF245454);
  static const Color primaryColor300=Color(0xFF245454);
  static const Color primaryColor400=Color(0xFF90A3A2);
  static const Color primaryColor500 = Color.fromARGB(207, 144, 163, 162);
  static const Color primaryColor600=Color.fromARGB(207, 144, 163, 162);
  static const Color primaryColor700=Color.fromARGB(207, 144, 163, 162);
  static const Color primaryColor800=Color(0xFFD2DEDE);
  static const Color primaryColor900=Color.fromARGB(197, 210, 222, 222);
  static const Color primaryColor1000=Color(0xFFffe6f0);
 static const Color textField = Color(0xFF90A3A2);
  static const Color black5 = Color(0xFFf2f2f2);

  static const Color otpBgColor = Color(0xFF172B33);
  static const Color secondaryColor=Color(0xFF90A3A2);
  ...
  static const Color warningColor = Color(0xFF013432);
  ...
  static const Color warningColor1 = Color(0xFF013432);
